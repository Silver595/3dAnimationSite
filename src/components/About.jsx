          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto">
            ...
            <div className="mt-12 flex flex-col items-center gap-6">
              <p className="font-general text-xl text-zinc-300 max-w-2xl leading-relaxed">
                I am a DevOps Engineer and Full Stack Developer dedicated to
                building resilient systems.
              </p>
              <p className=" text-xs text-zinc-500  tracking-widest max-w-md">
                [ Happiness lies in Vinland,] <br />
                and I'm far away from it.]
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="about-panel relative h-full w-screen flex-shrink-0 flex items-center justify-between p-10 md:p-32 border-r border-white/5 bg-[#0b0b0b]">
          <div className="flex flex-col flex-1 items-start z-10 max-w-xl">
            ...
            <p className="font-general text-zinc-400 text-lg leading-relaxed mb-6">
              I like to cook,read and design beyond the world of technical
              things.
              <br />
              Btw Keep scrolling.
            </p>
          ...
          <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center">
            <div>
              ...
              <p className="font-general text-zinc-400 max-w-md">
                Things I’m currently spending time learning and getting better
                at.
              </p>
            </div>
              ...
              {[
                {
                  title: "DevOps",
                  date: "Ongoing",
                  org: "Current Progress: Kubernetes ",
                },
                {
                  title: "Find a Job",
                  date: "Searching",
                  org: "Looking for my first step into DevOps",
                },
                {
                  title: "Get in Shape",
                  date: "Pending",
                  org: "Still Procrastinating",
                },
              ].map((cert, i) => (
                <div
                  key={i}
                  className="group flex items-center justify-between border-b border-white/10 py-6 hover:bg-white/[0.02] px-4 transition-colors"
                >
                  <div>
                    <h4 className="font-mono text-xl text-white mb-1 group-hover:text-zinc-200">
                      {cert.title}
                    </h4>
